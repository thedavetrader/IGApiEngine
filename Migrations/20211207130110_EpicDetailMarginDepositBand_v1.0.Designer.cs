...
namespace IGApi.Migrations
{
    ...
    [Migration("20211207130110_EpicDetailMarginDepositBand_v1.0")]
    partial class EpicDetailMarginDepositBand_v10
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IGApi.Model.EpicDetailCurrency", b =>
                {
                    b.HasOne("IGApi.Model.EpicDetail", "EpicDetail")
                        .WithOne("Currency")
                        .HasForeignKey("IGApi.Model.EpicDetailCurrency", "Epic")
            ...
            modelBuilder.Entity("IGApi.Model.EpicDetailMarginDepositBand", b =>
                {
                    b.HasOne("IGApi.Model.EpicDetail", "EpicDetail")
                        .WithOne("MarginDepositBand")
                        .HasForeignKey("IGApi.Model.EpicDetailMarginDepositBand", "Epic")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("IGApi.Model.EpicDetailSpecialInfo", b =>
                {
                    b.HasOne("IGApi.Model.EpicDetail", "EpicDetail")
                        .WithOne("SpecialInfo")
                        .HasForeignKey("IGApi.Model.EpicDetailSpecialInfo", "Epic")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("IGApi.Model.EpicDetail", b =>
                {
                    ...
                    b.Navigation("MarginDepositBand");
