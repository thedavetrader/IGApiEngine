    ...
    public partial class EpicDetail
    {
            ...
            )
        {
            ...
            if (dealingRulesData is not null)
            {
                ...
                DealingRuleValueMaxStopOrLimitDistance = dealingRulesData.maxStopOrLimitDistance.value;
                DealingRuleValueMinControlledRiskStopDistance = dealingRulesData.minControlledRiskStopDistance.value;
                DealingRuleValueMinDealSize = dealingRulesData.minDealSize.value;
                DealingRuleValueMinNormalStopOrLimitDistance = dealingRulesData.minNormalStopOrLimitDistance.value;
                DealingRuleValueMinStepDistance = dealingRulesData.minStepDistance.value;
            }
            #endregion
        }
    }
