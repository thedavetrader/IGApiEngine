...
namespace IGApi.Migrations
{
    ...
    [Migration("20211215155728_ClosePosition_v1.0")]
    partial class ClosePosition_v10
    {
            ...
            modelBuilder.Entity("IGApi.Model.RestRequestQueueItem", b =>
                {
                    ...
                    b.HasCheckConstraint("rest_request", "rest_request in ('GetAccountDetails','GetOpenPositions','GetWorkingOrders','GetActivityHistory','GetTransactionHistory','GetClientSentiment','CreatePosition','ClosePosition','GetEpicDetails')");
                });
