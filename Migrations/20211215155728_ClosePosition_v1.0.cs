...
{
    public partial class ClosePosition_v10 : Migration
    {
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.AddCheckConstraint(
                name: "CK_rest_request_queue_rest_request",
                table: "rest_request_queue",
                sql: "rest_request in ('GetAccountDetails','GetOpenPositions','GetWorkingOrders','GetActivityHistory','GetTransactionHistory','GetClientSentiment','CreatePosition','GetEpicDetails')");
        }
    }
}
