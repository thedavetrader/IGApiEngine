...
namespace IGApi.Migrations
{
    ...
    [Migration("20211215150646_OpenPosition_v1.0")]
            ...
            modelBuilder.Entity("IGApi.Model.RestRequestQueueItem", b =>
                {
                    ...
                    b.HasCheckConstraint("rest_request", "rest_request in ('GetAccountDetails','GetOpenPositions','GetWorkingOrders','GetActivityHistory','GetTransactionHistory','GetClientSentiment','CreatePosition','GetEpicDetails')");
                });
